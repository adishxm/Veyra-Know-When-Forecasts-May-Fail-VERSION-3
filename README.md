...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Backend%20Tests-923%20Passed-brightgreen.svg?style=for-the-badge&logo=pytest" alt="923 Backend Tests Passed" />
...
| **G14–G17**| Phase 7: CI & Test Suite | 923 backend tests + 111 frontend tests passing (1,034 total), release gate validation | `pytest backend/tests -q` & `npm test` | **100% PASSED** |
...
Veyra Sentinel includes an automated verification suite containing **1,034 verified passing automated tests (923 backend pytest + 111 frontend vitest tests)** with a clean production build, independently audited at commit [`c9903fa`](audit/baseline.md).
...
```bash
# Run all 923 backend tests (quiet mode)
...
|:---|:---:|:---|:---:|
| **All Tests (Full Regression)** | Gates 1–11 & P0–P8 | `python -m pytest backend/tests/ -q` | **923 passed** |
...
│   └── tests/                         # 923 automated backend tests (100% passing)
